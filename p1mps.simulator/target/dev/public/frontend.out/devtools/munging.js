...
var o56475 = temp__5733__auto__;
var temp__5733__auto____$1 = (o56475["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o56476 = temp__5733__auto____$1;
return (o56476["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__56254__auto__ = f;
return (o__56254__auto__["toString"]).call(o__56254__auto__);
} else {
return "";
}
}catch (e56477){var _ = e56477;
return "";
}});
...
try{var o__56254__auto___56479 = t;
(o__56254__auto___56479["cljs$lang$ctorPrWriter"]).call(o__56254__auto___56479,t,writer);
}catch (e56478){var __56480 = e56478;
}
...
var char_code = (function (){var o__56254__auto__ = (new String(char$));
return (o__56254__auto__["charCodeAt"]).call(o__56254__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__56254__auto__ = String;
return (o__56254__auto__["fromCharCode"]).call(o__56254__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__56481 = num_code;
switch (G__56481) {
case (1):
return (185);
...
var o__56254__auto__ = String;
return (o__56254__auto__["fromCharCode"]).call(o__56254__auto__,superscript_code);
});
/**
...
}catch (e56483){var _e__56261__auto__ = e56483;
return false;
}})())){
...
var vec__56484 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__56484,(0),null);
...
var or__3922__auto__ = (function (){var temp__5733__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5733__auto__)){
...
if(cljs.core.truth_(temp__5733__auto__)){
var o56487 = temp__5733__auto__;
var temp__5733__auto____$1 = (o56487["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o56488 = temp__5733__auto____$1;
return (o56488["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___56495 = arguments.length;
var i__4500__auto___56496 = (0);
while(true){
if((i__4500__auto___56496 < len__4499__auto___56495)){
args__4502__auto__.push((arguments[i__4500__auto___56496]));

var G__56497 = (i__4500__auto___56496 + (1));
i__4500__auto___56496 = G__56497;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__56491){
var vec__56492 = p__56491;
var ns_detector = cljs.core.nth.call(null,vec__56492,(0),null);
...
var G__56498 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__56499 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__56498;
remaining_tokens = G__56499;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq56489){
var G__56490 = cljs.core.first.call(null,seq56489);
var seq56489__$1 = cljs.core.next.call(null,seq56489);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56490,seq56489__$1);
});
...
var vec__56503 = cljs.core.split_with.call(null,(function (p1__56502_SHARP_){
return cljs.core.not_EQ_.call(null,p1__56502_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__56503,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__56503,(1),null);
...
var vec__56506 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__56506,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__56506,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__56509 = cljs.core.rest.call(null,remaining_tokens);
var G__56510 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__56509;
name_tokens = G__56510;
continue;
} else {
...
var vec__56513 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__56513,(0),null);
var arity = cljs.core.nth.call(null,vec__56513,(1),null);
var vec__56516 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__56516,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__56516,(1),null);
var vec__56519 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__56519,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__56519,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__56519,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__56519,(3),null);
...
var vec__56525 = result;
var munged_ns = cljs.core.nth.call(null,vec__56525,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__56525,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__56525,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__56525,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__56525,(4),null);
var arity = cljs.core.nth.call(null,vec__56525,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__56529 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__56529,(0),null);
var args = cljs.core.nth.call(null,vec__56529,(1),null);
var vec__56532 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__56532,(0),null);
var name = cljs.core.nth.call(null,vec__56532,(1),null);
...
var G__56535 = (arity + (1));
var G__56536 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__56537){
var vec__56538 = p__56537;
var arity = cljs.core.nth.call(null,vec__56538,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__56538,(1),null);
...
return (function (p1__56541_SHARP_){
return cljs.core.get.call(null,arities,p1__56541_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__56542_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___56549 = arguments.length;
var i__4500__auto___56550 = (0);
while(true){
if((i__4500__auto___56550 < len__4499__auto___56549)){
args__4502__auto__.push((arguments[i__4500__auto___56550]));

var G__56551 = (i__4500__auto___56550 + (1));
i__4500__auto___56550 = G__56551;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__56545){
var vec__56546 = p__56545;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__56546,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq56543){
var G__56544 = cljs.core.first.call(null,seq56543);
var seq56543__$1 = cljs.core.next.call(null,seq56543);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56544,seq56543__$1);
});
...
var G__56552 = arg;
var G__56552__$1 = (((G__56552 instanceof cljs.core.Keyword))?G__56552.fqn:null);
switch (G__56552__$1) {
...
var map__56554 = options;
var map__56554__$1 = ((((!((map__56554 == null)))?(((((map__56554.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56554.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56554):map__56554);
var include_ns_QMARK_ = cljs.core.get.call(null,map__56554__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__56554__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__56554__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__56554__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__56555 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__56555,(0),null);
var fn_name = cljs.core.nth.call(null,vec__56555,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__56555,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__56555,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__56555,(4),null);
var arity = cljs.core.nth.call(null,vec__56555,(5),null);
...
var o__56254__auto__ = f;
return (o__56254__auto__["getBasis"]).call(o__56254__auto__);
});
/**
...
}catch (e56559){var _e__56261__auto__ = e56559;
...
var G__56560 = (obj[cljs.core.first.call(null,path)]);
var G__56561 = cljs.core.rest.call(null,path);
obj = G__56560;
path = G__56561;
continue;
} else {
...
return (function (accum,p__56562){
var vec__56563 = p__56562;
var bit = cljs.core.nth.call(null,vec__56563,(0),null);
var protocol = cljs.core.nth.call(null,vec__56563,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__56566){
var vec__56567 = p__56566;
var ns = cljs.core.nth.call(null,vec__56567,(0),null);
var name = cljs.core.nth.call(null,vec__56567,(1),null);
var selector = cljs.core.nth.call(null,vec__56567,(2),null);
...
return (function (p__56571){
var vec__56572 = p__56571;
var munged_name = cljs.core.nth.call(null,vec__56572,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__56572,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__56572,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__56570_SHARP_){
return (obj[cljs.core.first.call(null,p1__56570_SHARP_)]);
});})(name,sorted_matches,vec__56572,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
