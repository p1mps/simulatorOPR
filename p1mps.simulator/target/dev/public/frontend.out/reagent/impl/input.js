...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__54117){
...
var on_write = cljs.core.get.call(null,map__54118__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__54118,map__54118__$1,on_write){
return (function (){
return reagent.impl.input.input_component_set_value.call(null,component);
});})(node_value,map__54118,map__54118__$1,on_write))
);
} else {
...
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__54120_SHARP_);
});})(v,value,on_change,original_ref_fn))
;
