...
var G__53751 = format;
var G__53751__$1 = (((G__53751 instanceof cljs.core.Keyword))?G__53751.fqn:null);
switch (G__53751__$1) {
case "transit":
return ajax.transit.transit_request_format.call(null,format_params);
...
var G__53753 = format;
var G__53753__$1 = (((G__53753 instanceof cljs.core.Keyword))?G__53753.fqn:null);
switch (G__53753__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__53755_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__53755_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__53756){
var map__53757 = p__53756;
var map__53757__$1 = ((((!((map__53757 == null)))?(((((map__53757.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53757.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53757):map__53757);
var handler = cljs.core.get.call(null,map__53757__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__53757__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__53757__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return ((function (h,e,map__53757,map__53757__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__53759){
var vec__53760 = p__53759;
var ok = cljs.core.nth.call(null,vec__53760,(0),null);
var result = cljs.core.nth.call(null,vec__53760,(1),null);
...
;})(h,e,map__53757,map__53757__$1,handler,error_handler,finally$))
});
/**
 ...
 */
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__53763){
var map__53764 = p__53763;
var map__53764__$1 = ((((!((map__53764 == null)))?(((((map__53764.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53764.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53764):map__53764);
var opts = map__53764__$1;
var method = cljs.core.get.call(null,map__53764__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__53764__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__53764__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__53764__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__53764__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
