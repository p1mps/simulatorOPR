...
var map__57681 = top_item;
var map__57681__$1 = ((((!((map__57681 == null)))?(((((map__57681.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57681.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__57681):map__57681);
var file = cljs.core.get.call(null,map__57681__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__57681__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__57681__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e57680){var _e = e57680;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___57683 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___57683)){
var seen_errors_57684 = temp__5733__auto___57683;
if(cljs.core.truth_(seen_errors_57684.has(self))){
} else {
seen_errors_57684.add(self);

var temp__5735__auto___57685 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___57685)){
var sense_57686 = temp__5735__auto___57685;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_57686)].join('');
} else {
}
}
} else {
