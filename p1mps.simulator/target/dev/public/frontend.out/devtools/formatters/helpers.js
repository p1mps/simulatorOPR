...
var G__56577 = devtools.prefs.pref.call(null,v);
v = G__56577;
continue;
} else {
return v;
...
}catch (e56580){var _e__56261__auto__ = e56580;
return false;
}})();
...
}catch (e56584){var _e__56261__auto__ = e56584;
return false;
}})();
...
}catch (e56586){var _e__56261__auto__ = e56586;
return false;
}}
}
});
...
var vec__56588 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__56588,(0),null);
var name = cljs.core.nth.call(null,vec__56588,(1),null);
...
return cljs.core.some.call(null,(function (p1__56591_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__56591_SHARP_);
}),template);
});
