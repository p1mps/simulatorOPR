...
return cljs.core.some.call(null,((function (accept){
return (function (p1__53517_SHARP_){
return ajax.formats.content_type_matches.call(null,content_type,p1__53517_SHARP_);
});})(accept))
,accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__53518){
var map__53519 = p__53518;
var map__53519__$1 = ((((!((map__53519 == null)))?(((((map__53519.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53519.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53519):map__53519);
var request = map__53519__$1;
var response_format = cljs.core.get.call(null,map__53519__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var content_type = ajax.util.get_content_type.call(null,response);
var accepted_format_QMARK_ = ((function (content_type,map__53519,map__53519__$1,request,response_format){
return (function ajax$formats$get_default_format_$_accepted_format_QMARK_(format_entry){
return ajax.formats.detect_content_type.call(null,content_type,request,format_entry);
});})(content_type,map__53519,map__53519__$1,request,response_format))
;
...
ajax.formats.accept_header = (function ajax$formats$accept_header(p__53522){
var map__53523 = p__53522;
var map__53523__$1 = ((((!((map__53523 == null)))?(((((map__53523.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53523.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53523):map__53523);
var request = map__53523__$1;
var response_format = cljs.core.get.call(null,map__53523__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.call(null,((function (formats,map__53523,map__53523__$1,request,response_format){
return (function (p1__53521_SHARP_){
return ajax.formats.get_accept_entries.call(null,request,p1__53521_SHARP_);
});})(formats,map__53523,map__53523__$1,request,response_format))
,formats);
});
/**
